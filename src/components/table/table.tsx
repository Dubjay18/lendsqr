...
const Table = ({ children, tableProps, changeData,className, ...rest } :{children: React.ReactNode; tableProps: IUsercontext;className: string; changeData: (data:any)=>void;}) => {
